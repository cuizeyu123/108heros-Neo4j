...
export default function HeroesGraphPage() {
  ...
  return (
    <div className="h-full flex flex-col relative">
      {/* ─── 顶栏 ─── */}
      <header className="relative flex items-center justify-between px-5 py-3 bg-[var(--color-bg-secondary)] flex-shrink-0 z-20">
      ...
      <div className="flex-1 flex min-h-0 relative">
        <div
          className={`flex-1 min-w-0 ${showDetailMobile ? 'hidden lg:block' : 'block'}`}
        >
          <KnowledgeGraph
            data={data}
        ...
        {/* 详情面板 */}
        <div
          className={`${hero || !showDetailMobile ? 'flex' : 'hidden'} lg:flex w-full lg:w-[400px] flex-shrink-0 ${
